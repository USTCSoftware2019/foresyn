...
class CobraModelApi(View):
    def post(self, request):
        ...
        try:
            ...
            return JsonResponse({'code': 200021, 'message': error.messages}, status=400)
        except AttributeError as error:
            return JsonResponse({'code': 200011, 'message': error.args}, status=400)
        except ValidationError as error:
            return JsonResponse({'code': 200001, 'message': error.messages}, status=400)
        model.save()
...
class CobraReactionApi(View):
    def post(self, request):
        ...
        try:
            ...
            return JsonResponse({'code': 200022, 'message': error.args}, status=400)
        except ObjectDoesNotExist as error:
            return JsonResponse({'code': 200012, 'message': error.messages}, status=400)
        except ValidationError as error:
            return JsonResponse({'code': 200002, 'message': error.messages}, status=400)
        reaction.save()
...
class CobraMetaboliteApi(View):
    def post(self, request):
        ...
        try:
            ...
            return JsonResponse({'code': 200013, 'message': error.args}, status=400)
        except ValidationError as error:
            return JsonResponse({'code': 200003, 'message': error.messages}, status=400)
        metabolite.save()
