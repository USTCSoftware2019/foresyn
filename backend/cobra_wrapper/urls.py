...
urlpatterns = [
    ...
    path('metabolites/<int:model_id>/', views.CobraMetaboliteObjectApi.as_view(), name='metabolite_object'),
    path('reactions/', views.CobraReactionSetApi.as_view(), name='reaction_set'),
    path('reactions/<int:model_id>/', views.CobraReactionObjectApi.as_view(), name='reaction_object'),
